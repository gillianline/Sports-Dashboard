...
.vibe-table { color: #ffffff; width:100%; border-collapse: collapse; margin-bottom: 20px; margin-left: auto; margin-right: auto; }
...
with tab_indiv:
    ...
    with col_img:
        st.image("https://via.placeholder.com/250x350/0d1117/3880ff?text=ATHLETE+PHOTO", width=250)
    with col_info:
...
with tab_team:
    ...
    for metric in metrics_list:
        st.markdown(f"<div style='text-align:center; color:#00d4ff; margin-top:20px;'><b>Top 5: {metric.replace('_',' ')}</b></div>", unsafe_allow_html=True)
